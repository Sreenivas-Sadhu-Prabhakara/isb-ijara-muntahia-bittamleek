package com.bank.islamic.ijaramuntahiabittamleek.model;
...
/**
 * The BIAN control record for this service domain: "Lease To Own Arrangement Fulfillment Arrangement".
 *
 ...
 * to its asset type (Lease To Own Arrangement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Lease To Own Arrangement Fulfillment Arrangement";
